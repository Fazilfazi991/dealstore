...
- The local Meta feed contains 88 unique size variants across all live, feed-ready verified products, including Products 2–4, 7 and 16–25. No verified live product is blocked from feed generation. Every row uses HTTPS, free shipping, exact size-wise retail pricing, and excludes internal source-cost/profit fields. It has not been uploaded to Meta.
