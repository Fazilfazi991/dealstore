...
- The local Meta feed contains 72 unique size variants across all live, feed-ready verified products, including Product 2 and Products 16–25. Every row uses HTTPS, free shipping, exact size-wise retail pricing, and excludes internal source-cost/profit fields. It has not been uploaded to Meta.
