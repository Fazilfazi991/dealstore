...
- Twenty-six tracked records: eighteen approved, source-verified and production-QA-verified products; seven legacy-published originals that still require exact-source backfill; and Product 15 as a quarantined identity-corrected draft. The production website exposes twenty-five sellable products because Product 15 remains excluded.
...
- MSH-EXP-026 is approved, live and Meta-ready: a black-and-beige diamond-print rayon kurta-pant set at ₹416 source and ₹616 retail for measured S/M variants. L–XXXL remain withheld because source measurements are missing. Six separate watermark-free 4:5 assets passed source-match and cross-view QA; supplier-watermarked source photos were not reused. Production QA verified all six public image URLs, size M through cart and selected COD checkout, FREE delivery, zero mobile overflow and no console errors.
...
- The local Meta feed contains 100 unique size variants across the eighteen live, feed-ready verified products: originals 1, 2, 3, 4, 7, 8 and 10 plus Products 16–26. No verified live product is blocked from feed generation. Every row uses HTTPS, free shipping, exact size-wise retail pricing, and excludes internal source-cost/profit fields. It has not been uploaded to Meta.
...
- The 2026-08-31 catalogue gate passes with 26 tracked records and 25 sellable website products. It reports warnings—not hard failures—for the seven remaining unverified legacy originals and the intentionally incomplete Product 15 draft; Product 26 passed production commerce QA and is Meta-ready.
...
- Latest local release gates after Product 26 staging: tracked-source ESLint pass, TypeScript pass, 24/24 tests pass, `meesho:validate` pass with 26 tracked/25 sellable and only known legacy/Product 15 warnings, asset validation pass through all 26 records, and Vinext production build pass.
...
4. Keep Product 26 under daily source monitoring; do not expand beyond measured S/M or upload its Meta rows without a fresh approval decision.
