...
('MSH-EXP-015','maroon-rayon-co-ord-set','Maroon Rayon Co-ord Set','kurta-sets',0,'A maroon kurta with coordinated wide-leg pants. Commercial details require source verification.','Rayon','Maroon',array[]::text[],false,false,false);
